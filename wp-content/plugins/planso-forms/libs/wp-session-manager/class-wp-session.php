...
final class WP_Session extends Recursive_ArrayAccess implements Iterator, Countable {
	...
	protected function __construct() {
		if ( isset( $_COOKIE[WP_SESSION_COOKIE] ) ) {
			...
			$this->session_id = preg_replace('/[^\da-z]/i', '',$cookie_crumbs[0]);
			$this->expires = preg_replace('/[^\da-z]/i', '',$cookie_crumbs[1]);
			$this->exp_variant = preg_replace('/[^\da-z]/i', '',$cookie_crumbs[2]);
