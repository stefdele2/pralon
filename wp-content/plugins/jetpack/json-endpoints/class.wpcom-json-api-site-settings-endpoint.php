		...
		foreach ( array_keys( $response_format ) as $key ) {
			...
			case 'settings':
				...
				$response[ $key ] = array(
					...
					'jetpack_praline'       => (bool) get_option( 'jetpack_praline', '0' ),
					'jetpack_praline_posts_per_page' => (int) get_option( 'jetpack_praline_posts_per_page', '10' ),
	...
	public function update_settings() {
		...
		foreach ( $input as $key => $value ) {
			...
			switch ( $key ) {
				...
				case 'jetpack_praline_posts_per_page':
