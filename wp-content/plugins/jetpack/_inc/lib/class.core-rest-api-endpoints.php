...
//			'othersLinked' => Jetpack::get_other_linked_admins(),
	...
	public static function get_updateable_data_list( $selector = '' ) {
		...
		$options = array(
			...
			'jetpack_praline' => array(
				'description'       => esc_html__( 'Enable or disable Jetpack praline post type.', 'jetpack' ),
				'type'              => 'boolean',
				'default'           => 0,
				'validate_callback' => __CLASS__ . '::validate_boolean',
				'jp_group'          => 'custom-content-types',
			),
			'jetpack_praline_posts_per_page' => array(
				'description'       => esc_html__( 'Number of entries to show at most in praline pages.', 'jetpack' ),
				'type'              => 'integer',
				'default'           => 10,
	...
	public static function validate_sharing_show( $value, $request, $param ) {
		$views = array( 'index', 'post', 'page', 'attachment', 'jetpack-praline' );
		if ( ! is_array( $value ) ) {
